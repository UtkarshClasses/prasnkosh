...
Widget subjectFilterWidget(context) {
        ...
        child: Column(
          ...
          children: [
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () async {
                      ...
                      List<Data> data = await getSuggestionsAPI("subject");
                      filterListController
                          .filtersMap['Subject']['possible_item'].value = data;
                      EasyLoading.dismiss();
            ...
            Obx(() => selectedItemChips(
                filterListController.filtersMap["Subject"]['selected_item'])),
          ],
        ),
      ),
    ),
...
void openFilterDialog(context) async {
  ...
  await FilterListDialog.display(
    ...
    listData: filterListController.filtersMap['Subject']['possible_item']
        .cast<Data>(),
    selectedListData: selectedItem,
    choiceChipLabel: (item) => "${item!.title}(${item.id})",
    validateSelectedItem: (list, val) => list!.contains(val),
    onApplyButtonClick: (list) {
      filterListController.filtersMap["Subject"]["selected_item"].value = list;
      Get.back();
    },
