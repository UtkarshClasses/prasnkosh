...
Widget examsFilterWidget(context) {
        ...
        child: Column(
          ...
          children: [
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () async {
                      ...
                      List<Data> data = await getSuggestionsAPI("exam");
                      filterListController
                          .filtersMap['Exam']['possible_item'].value = data;
                      EasyLoading.dismiss();
            ...
            Obx(() => selectedItemChips(
                filterListController.filtersMap["Exam"]['selected_item'])),
          ],
        ),
      ),
    ),
...
void openFilterDialog(context) async {
  ...
  List<Data> selectedItem =
      filterListController.filtersMap['Exam']['selected_item'].cast<Data>();
