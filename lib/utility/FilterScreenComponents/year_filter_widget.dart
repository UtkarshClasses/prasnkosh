...
Widget yearFilterWidget(context) {
        ...
        child: Column(
          children: [
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () async {
                      ...
                      List<dynamic> data = await getSuggestionsAPI("year");
                      filterListController
                          .filtersMap['Year']['possible_item'].value = data;
                      EasyLoading.dismiss();
            ...
            Obx(() => selectedItemChips(
                filterListController.filtersMap["Year"]['selected_item'])),
          ],
        ),
      ),
    ),
...
void openFilterDialog(context) async {
  ...
  List<String> selectedItem =
      filterListController.filtersMap['Year']['selected_item'].cast<String>();
  await FilterListDialog.display(
    context,
    height: 500,
    backgroundColor: Colors.yellow,
    listData:
        filterListController.filtersMap['Year']['possible_item'].cast<String>(),
    selectedListData: selectedItem,
    choiceChipLabel: (item) => item,
    validateSelectedItem: (list, val) => list!.contains(val),
    onApplyButtonClick: (list) {
      filterListController.filtersMap["Year"]["selected_item"].value = list;
      Get.back();
    },
