...
Widget categoryFilterWidget(context) {
        ...
        child: Column(
          children: [
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () async {
                      ...
                      List<dynamic> data = await getSuggestionsAPI("category");
                      filterListController
                          .filtersMap['Category']['possible_item'].value = data;
                      EasyLoading.dismiss();
            ...
            Obx(() => selectedItemChips(
                filterListController.filtersMap["Category"]['selected_item'])),
          ],
        ),
      ),
    ),
...
void openFilterDialog(context) async {
  ...
  await FilterListDialog.display(
    ...
    onApplyButtonClick: (list) {
      filterListController.filtersMap["Category"]["selected_item"].value = list;
      Get.back();
    },
