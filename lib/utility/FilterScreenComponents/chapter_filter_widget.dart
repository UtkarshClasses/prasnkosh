...
import '../../apis/getSuggestionsAPI.dart';
import '../../controllers/filter_list_controller.dart';

Widget chapterFilterWidget(context) {
        ...
        child: Column(
          children: [
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () async {
                      ...
                      List<Data> data = await getSuggestionsAPI("chapter");
                      filterListController
                          .filtersMap['Chapter']['possible_item'].value = data;
                      EasyLoading.dismiss();
            ...
            Obx(() => selectedItemChips(
                filterListController.filtersMap["Chapter"]['selected_item'])),
          ],
        ),
      ),
    ),
...
void openFilterDialog(context) async {
  var filterListController = Get.put(FilterListController());
  List<Data> selectedItem = filterListController.filtersMap['Chapter']
          ['selected_item']
      .cast<Data>();
  await FilterListDialog.display(
    ...
    listData: filterListController.filtersMap['Chapter']['possible_item']
        .cast<Data>(),
    selectedListData: selectedItem,
    choiceChipLabel: (item) => item!.title.toString(),
    validateSelectedItem: (list, val) => list!.contains(val),
    onApplyButtonClick: (list) {
      filterListController.filtersMap["Chapter"]["selected_item"].value = list;
      Get.back();
    },
