...
Widget boardFilterWidget(context) {
        ...
        child: Column(
          ...
          children: [
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () async {
                      ...
                      List<dynamic> data = await getSuggestionsAPI("board");
                      filterListController
                          .filtersMap['Board']['possible_item'].value = data;
                      EasyLoading.dismiss();
            ...
            Obx(() => selectedItemChips(
                filterListController.filtersMap["Board"]['selected_item'])),
          ],
        ),
      ),
    ),
...
void openFilterDialog(context) async {
  ...
  List<String> selectedItem =
      filterListController.filtersMap['Board']['selected_item'].cast<String>();
  await FilterListDialog.display(
    ...
    onApplyButtonClick: (list) {
      filterListController.filtersMap["Board"]["selected_item"].value = list;
      Get.back();
    },
