...
Widget collectionFilterWidget(context) {
      ...
      child: ConstrainedBox(
        ...
        child: Column(
          ...
          children: [
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () async {
                      ...
                      List<dynamic> data =
                          await getSuggestionsAPI("collection");
                      filterListController
                          .filtersMap['Collection']['possible_item']
                          .value = data;
                      EasyLoading.dismiss();
            ...
            Obx(() => selectedItemChips(filterListController
                .filtersMap["Collection"]['selected_item'])),
          ],
        ),
      ),
    ),
...
void openFilterDialog(context) async {
  var filterListController = Get.put(FilterListController());
  List<String> selectedItem = filterListController.filtersMap['Collection']
          ['selected_item']
      .cast<String>();
  await FilterListDialog.display(
    ...
    listData: filterListController.filtersMap['Collection']['possible_item']
        .cast<String>(),
    selectedListData: selectedItem,
    choiceChipLabel: (item) => item,
    validateSelectedItem: (list, val) => list!.contains(val),
    onApplyButtonClick: (list) {
      filterListController.filtersMap["Collection"]["selected_item"].value =
          list;
      Get.back();
    },
